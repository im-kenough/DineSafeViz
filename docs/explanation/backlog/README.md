...
| Item | From | Phase |
|---|---|---|
| [Failure Mode Analysis](failure-mode-analysis.md) | Reliability R2 | Phase 1 |
| [DR activation runbook (RB-16)](dr-runbook-rb16.md) | Reliability R3 | Phase 2 |
| [Recovery drill](recovery-drill.md) | Reliability R3 | Phase 2 |
| [Backup immutability](backup-immutability.md) | Reliability R3 | Phase 1 |
| [AKS upgrade runbook](aks-upgrade-runbook.md) | Reliability R4 | Phase 1 |
| [Failure simulation](failure-simulation.md) | Reliability R4 | Phase 3 |
| [Incident-review process](incident-review-process.md) | Reliability R4 | Phase 3 |
